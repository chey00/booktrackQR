...
## DMG-Datein ( Fertige BookTrackQR.app) 
...
Version: V 1.9 ( Stand vom 28.04.26) wurde vom Daniel Popp erstellt 

Version: V 1.7 ( Stand vom 16.0426 ) war die letzte DMG - Datei die von mir( Denis Sukkau) erstellt wurde. 
